...
export const d6s = `mjqjpqmgbljsphdztnvjfqwrcgsmlb`;

export const d6i = ``;
...
export const d8s = `30373
25512
65332
33549
35390`;

export const d8i = `122202212311200210333041243104410211022242435153422552354101423030331120103122123201123013212020121
