...
splitLinesIntoArray(d24i).forEach((row, rowIndex) => {
...
function q2() {
    ...
    console.log("d24q2: " + (firstMoves + secondMoves + thirdMoves));
}

function move(from: Position, to: Position, startingBlizzards: Blizzards): [number, Blizzards] {
...
function moveBlizzards(blizzards: Blizzards) {
...
function getPosFromKey(key: string) {
